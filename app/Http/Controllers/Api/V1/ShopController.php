...
class ShopController extends Controller
{
    ...
    public function apply(Request $request)
    {
        ...
        $fill = [
            ...
            // New shops start Inactive — hidden from the public Shops page
            // until an admin activates them. This is the shop_status flag,
            // NOT status ('1' stays so the owner can always log in).
