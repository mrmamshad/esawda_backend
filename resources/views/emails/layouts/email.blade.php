...
<head>
    ...
    <style>
        ...
        .header { background-color: #ffffff; padding: 20px 32px; border-bottom: 3px solid #FF003F; }
        ...
        .btn { display: inline-block; background-color: #FF003F; color: #ffffff !important; text-decoration: none; padding: 12px 24px; border-radius: 8px; font-weight: 600; font-size: 14px; margin: 8px 0 16px; }
        ...
        .footer a { color: #FF003F; text-decoration: none; }
                ...
                <table role="presentation" class="container" cellpadding="0" cellspacing="0">
                    <tr>
                        <td>
                            <div class="card">
                                <div class="header">
                                    <a href="{{ $frontendUrl ?? '' }}"><img src="{{ rtrim($frontendUrl ?? '', '/').'/logo.png' }}" alt="eSawda" height="44"></a>
                                </div>
                                <div class="body">
                                    @yield('content')
                                </div>
                                <div class="footer">
                                    eSawda — buy and sell with confidence.<br>
