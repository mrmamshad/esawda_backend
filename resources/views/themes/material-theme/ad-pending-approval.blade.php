...
<div id="page-content">
    <div class="container">
        <ul class="breadcrumb bcstyle2">
            ...
            <li class="active"><a>{{ __('quickad.pending_ads') }}</a></li>
        </ul>
        <a href="{{ $link['POST-AD'] ?? '#' }}" class="postadinner"><span> <i class="fa fa-plus-circle"></i> {{ __('quickad.post_ad') }}</span></a>
        <!--end breadcrumb-->
        <section class="page-title center"><h1>{{ __('quickad.pending_ads') }}</h1></section>
        <!--end page-title-->
        <section>
            <div class="row mt40">
                                ...
                                <div class="collapse-box"><h5 class="collapse-title"> {{ __('quickad.my_ads') }} <a class="pull-right" data-toggle="collapse" href="#MyAds"><i class="fa fa-angle-down"></i></a></h5>
                                    ...
                                    <div id="MyAds" class="panel-collapse collapse in">
                                        <ul class="acc-list">
                                            ...
                                            <li class="active"><a href="{{ $link['PENDINGADS'] ?? '#' }}" class="waves-effect"><i class="fa fa-flag"></i> {{ __('quickad.pending_approval') }} <span class="badge">{{ $pendingads ?? '' }}</span></a></li>
                ...
                <div class="col-sm-9 page-content">
                    <div class="inner-box"><h1>{{ __('quickad.pending_ads') }} </h1>
