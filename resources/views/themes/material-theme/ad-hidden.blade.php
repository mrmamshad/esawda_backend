...
<div id="page-content">
    <div class="container">
        <ul class="breadcrumb bcstyle2">
            ...
            <li class="active"><a>{{ __('quickad.hidden_ads') }}</a></li>
        </ul>
        <a href="{{ $link['POST-AD'] ?? '#' }}" class="postadinner"><span> <i class="fa fa-plus-circle"></i> {{ __('quickad.post_ad') }}</span></a>
        <!--end breadcrumb-->
        <section class="page-title center"><h1>{{ __('quickad.hidden_ads') }}</h1></section>
        <!--end page-title-->
        <section>
            <div class="row mt40">
                <!-- Page-Sidebar -->
                            ...
                            <div class="collapse-box"><h5 class="collapse-title"> {{ __('quickad.my_ads') }} <a class="pull-right" data-toggle="collapse" href="#MyAds"><i class="fa fa-angle-down"></i></a></h5>
                                ...
                                <div id="MyAds" class="panel-collapse collapse in">
                                    <ul class="acc-list">
                                        ...
                                        <li class="active"><a href="{{ $link['HIDDENADS'] ?? '#' }}" class="waves-effect"><i class="fa fa-flag"></i> {{ __('quickad.hidden_ads') }} <span class="badge">{{ $hiddenads ?? '' }}</span></a></li>
                ...
                <div class="col-sm-9 page-content">
                    <div class="inner-box"><h1>{{ __('quickad.hidden_ads') }} </h1>
                        ...
                        <div class="table-responsive">
                            ...
                            <table id="js-table-list" class="table table-striped table-bordered add-manage-table table demo footable-loaded footable" data-filter="#filter" data-filter-text-only="true">
                                ...
                                <tr class="ajax-item-listing @if((data_get($item ?? [], 'status', ''))=="hide") opapcityLight @endif" data-item-id="{{ data_get($item ?? [], 'id', '') }}" data-item-id="{{ data_get($item ?? [], 'id', '') }}" data-search-term="{{ data_get($item ?? [], 'product_name', '') }}">
