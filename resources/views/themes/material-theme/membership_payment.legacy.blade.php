...
<div id="page-content">
    <div class="container">
        <ul class="breadcrumb bcstyle2">
            ...
            <li class="active"><a>{{ __('quickad.payment_method') }}</a></li>
        </ul>
        <a href="{{ $link['POST-AD'] ?? '#' }}" class="postadinner"><span> <i class="fa fa-plus-circle"></i> {{ __('quickad.post_ad') }}</span></a>
        <!--end breadcrumb-->
        <section class="page-title center"><h1>{{ __('quickad.payment_method') }}</h1></section>
        <!--end page-title-->
        <section>
            <div class="row">
                <!-- Page-Content -->
                                ...
                                @foreach($payment_types ?? [] as $payment_types)
                                    ...
                                    <div class="payment-tab payment-tab-active">
                                        ...
                                        <div class="payment-tab-content">
                                            ...
                                            <strong>{{ __('quickad.payment_type') }}</strong>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="">
                                                        <input id="one-time" name="payment_mode" type="radio" value="one_time" checked="">
                                                        <label for="one-time">{{ __('quickad.one_time_payment') }}</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="">
                                                        <input id="recurring" name="payment_mode" type="radio" value="recurring">
                                                        <label for="recurring">{{ __('quickad.recurring_payment') }}</label>
                                                    </div>
                                                </div>
                                            </div>
                                            @endif
                                        ...
                                        <div class="payment-tab-content">
                                            <div class="quickad-template">
                                                <table class="default-table table-alt-row PaymentMethod-infoTable">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <h5 class="PaymentMethod-heading">{{ __('quickad.bank_account_details') }}</h5>
                                                            <span class="PaymentMethod-info">{{ $bank_info ?? '' }}</span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <h5 class="PaymentMethod-heading">{{ __('quickad.reference') }}</h5>
                                                            <span class="PaymentMethod-info">
                                                                    {{ __('quickad.membershipplan') }} : {{ $order_title ?? '' }}<br>
                                                                {{ __('quickad.username') }}: {{ $username ?? '' }}<br><br>
                                                                {{ __('quickad.offline_credit_note') }}
                                                                </span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <h5 class="PaymentMethod-heading">{{ __('quickad.amount_to_send') }}</h5>
