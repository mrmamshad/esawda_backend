...
<div id="header">
    <div class="container">
        ...
        <a href="{{ $link['DASHBOARD'] ?? '#' }}">{{ __('quickad.dashboard') }}</a>
    </div>
</div>
          ...
          <header class="wchat-header">
            ...
            <div class="header-body">
              <div class="header-main">
                <div class="header-title">{{ __('quickad.profile') }}</div>
              </div>
            </div>
          </header>
                    ...
                    <div id="contact-list">
                            ...
                            <div class="chat-avatar">
                                <div class="avatar icon-user-default" style="height: 40px; width: 40px;">
                                    <div class="avatar-body userimage"><img
                                                src="{{ $site_url ?? '' }}storage/profile/{{ $userimg ?? '' }}"
                        ...
                        <div class="form-material">
                            <input class="form-control p-lr-20 live-search-box search_bg" id="searchbox" type="text"
                                   placeholder="{{ __('quickad.searchbyunorem') }}">
                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="white-box text-center bg-purple uploadFile" id="uploadFile">
                                                    <a href="#" class="text-white" data-toggle="tooltip" title=""
                                                       data-original-title="{{ __('quickad.photos') }}"><i
                                            ...
                                            <div class="col-sm-12">
                                                <div class="white-box text-center bg-success uploadFile"><a href="#"
                                                                                                            ...
                                                                                                            data-toggle="tooltip"
                                                                                                            title=""
                                                                                                            data-original-title="{{ __('quickad.videos') }}"><i
                                            ...
                                            <div class="col-sm-12">
                                                <div class="white-box text-center bg-info uploadFile"><a href="#"
                                                                                                         ...
                                                                                                         data-toggle="tooltip"
                                                                                                         title=""
                                                                                                         data-original-title="{{ __('quickad.documents') }}"><i
                            ...
                            <div class="menu-item active dropdown pull-right">
                                ...
                                <ul class="dropdown-menu dropdown-user animated flipInY">
                                    <li><a href="#" onclick="javascript:ShowProfile();"><i
                                                    class="ti-user"></i> {{ __('quickad.view_profile') }}</a></li>
                                    <li><a href="{{ $link['DASHBOARD'] ?? '#' }}"><i class="ti-wallet"></i> {{ __('quickad.dashboard') }}</a></li>
                                    <li><a href="{{ $link['LOGOUT'] ?? '#' }}"><i class="fa fa-power-off"></i> {{ __('quickad.logout') }}</a></li>
                                </ul>
                                <!-- /.dropdown-user --></div>
...
<script>
    ...
    var LANG_NAME = "{{ __('quickad.name') }}";
    var LANG_GENDER = "{{ __('quickad.gender') }}";
    var LANG_ABOUT = "{{ __('quickad.about') }}";
</script>
@if(($quickchat_socket_on_off ?? "")=='on')
<script>
