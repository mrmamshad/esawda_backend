        ...
        <div class="row">
            <div class="col-md-6 col-sm-8 col-md-offset-3 col-sm-offset-2">
                <div class="middle-dabba">
                    ...
                    <h1>{{ __('quickad.req_pass') }}</h1>
                    <p class="modal-title">{{ __('quickad.sendlink_newpass') }}.</p>
                    <div id="post-form" style="padding:0 10px 10px">
                        ...
                        <form name="form1" method="post" action="{{ $link['LOGIN'] ?? '#' }}" id="send">
                            ...
                            <div class="input-field">
                                <label for="email">{{ __('quickad.enter_mail') }}</label>
                            ...
                            <div class="input-field">
                                ...
                                <button class="btn btn-primary waves-effect" type="submit" name="Submit" ><span>{{ __('quickad.req_pass') }}</span></button>
                            </div>
