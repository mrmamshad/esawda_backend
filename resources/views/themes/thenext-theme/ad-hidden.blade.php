...
<div id="titlebar" class="margin-bottom-0">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h2>{{ __('quickad.hidden_ads') }}</h2>
                <!-- Breadcrumbs -->
                <nav id="breadcrumbs">
                    <ul>
                        <li><a href="{{ $link['INDEX'] ?? '#' }}">{{ __('quickad.home') }}</a></li>
                        <li>{{ __('quickad.hidden_ads') }}</li>
                    </ul>
                </nav>
        ...
        <div class="row">
                            ...
                            <div class="dashboard-nav">
                                <div class="dashboard-nav-inner">
                                    ...
                                    <ul data-submenu-title="{{ __('quickad.my_ads') }}">
                                        ...
                                        <li class="active"><a href="{{ $link['HIDDENADS'] ?? '#' }}"><i class="icon-feather-eye-off"></i> {{ __('quickad.hidden_ads') }} <span class="nav-tag">{{ $hiddenads ?? '' }}</span></a></li>
            ...
            <div class="col-lg-9 col-md-12">
                <div class="dashboard-box margin-top-0">
                    <!-- Headline -->
                    <div class="headline">
                        <h3><i class="icon-feather-eye-off"></i> {{ __('quickad.hidden_ads') }}</h3>
                    </div>
                    <div class="content with-padding">
                        <div class="table-responsive">
                            <table id="js-table-list" class="basic-table dashboard-box-list">
                                ...
                                <tr class="ajax-item-listing" data-item-id="{{ data_get($item ?? [], 'id', '') }}">
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        @if((data_get($item ?? [], 'hide', ''))=="0")
                                        <a href="#" data-ajax-action="hideItem" class="button gray ripple-effect ico item-js-hide" data-tippy-placement="top" title="{{ __('quickad.hide') }}"><i class="icon-feather-eye-off"></i></a>
                                        {{ $else ?? '' }}
                                        <a href="#" data-ajax-action="hideItem" class="button gray ripple-effect ico item-js-hide" data-tippy-placement="top" title="{{ __('quickad.show') }}"><i class="icon-feather-eye"></i></a>
                                        @endif
