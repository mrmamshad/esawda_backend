...
<div id="titlebar">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h2>{{ __('quickad.payment_method') }}</h2>
                <!-- Breadcrumbs -->
                <nav id="breadcrumbs">
                    <ul>
                        <li><a href="{{ $link['INDEX'] ?? '#' }}">{{ __('quickad.home') }}</a></li>
                        <li>{{ __('quickad.payment_method') }}</li>
                    </ul>
                </nav>
    ...
    <div class="row">
        <div class="col-xl-8 col-lg-8 content-right-offset">
            ...
            <form id="subscribeForm" method="POST" novalidate="novalidate">
                                    ...
                                    <div class="row payment-form-row">
                                        <div class="col-12">
                                            <div class="card-label form-group">
                                                <input type="text" class="form-control" name="checkoutCardNumber" placeholder="{{ __('quickad.card_number') }}" autocomplete="cc-number" required autofocus/>
                                            </div>
                                        </div>
                                        <div class="col-7">
                                            <div class="card-label form-group">
                ...
                <button type="submit" name="Submit" class="button big ripple-effect margin-top-40 margin-bottom-65 subscribeNow" id="subscribeNow">{{ __('quickad.confirm_pay') }}</button>
            </form>
        </div>
