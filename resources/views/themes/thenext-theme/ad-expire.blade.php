...
<div id="titlebar" class="margin-bottom-0">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h2>{{ __('quickad.expire_ads') }}</h2>
                <!-- Breadcrumbs -->
                <nav id="breadcrumbs">
                    <ul>
                        <li><a href="{{ $link['INDEX'] ?? '#' }}">{{ __('quickad.home') }}</a></li>
                        <li>{{ __('quickad.expire_ads') }}</li>
                    </ul>
                </nav>
        ...
        <div class="row">
                            ...
                            <div class="dashboard-nav">
                                <div class="dashboard-nav-inner">
                                    ...
                                    <ul data-submenu-title="{{ __('quickad.my_ads') }}">
                                        ...
                                        <li class="active"><a href="{{ $link['EXPIREADS'] ?? '#' }}"><i class="icon-feather-alert-octagon"></i> {{ __('quickad.expire_ads') }} <span class="nav-tag">{{ $totalitem ?? '' }}</span></a></li>
            ...
            <div class="col-lg-9 col-md-12">
                <div class="dashboard-box margin-top-0">
                    <!-- Headline -->
                    <div class="headline">
                        <h3><i class="icon-feather-alert-octagon"></i> {{ __('quickad.expire_ads') }}</h3>
                    </div>
                        ...
                        <div class="table-responsive">
                            <table id="js-table-list" class="basic-table dashboard-box-list">
                                ...
                                <tr class="ajax-item-listing" data-item-id="{{ data_get($item ?? [], 'id', '') }}">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div class="job-listing-footer font-14">
                                                            <ul>
                                                                ...
                                                                <li><i class="la la-calendar-times-o"></i> {{ __('quickad.expired_on') }}: {{ data_get($item ?? [], 'expire_date', '') }}</li>
                                                            </ul>
                                    ...
                                    <td>
                                        <a href="{{ $link['EDIT-AD'] ?? '#' }}/{{ data_get($item ?? [], 'id', '') }}" class="button gray ripple-effect ico" data-tippy-placement="top" title="{{ __('quickad.renew') }}"><i class="icon-feather-edit"></i></a>
