            ...
            <div class="col-md-12">
                ...
                <nav id="breadcrumbs">
                    <ul>
                        ...
                        <li>{{ __('quickad.resubmited_ads') }}</li>
                    </ul>
                </nav>
        ...
        <div class="row">
                            ...
                            <div class="dashboard-nav">
                                <div class="dashboard-nav-inner">
                                    ...
                                    <ul data-submenu-title="{{ __('quickad.my_ads') }}">
                                        ...
                                        <li class="active"><a href="{{ $link['RESUBMITADS'] ?? '#' }}"><i class="icon-feather-rotate-cw"></i> {{ __('quickad.resubmited_ads') }} <span class="nav-tag">{{ $resubmitads ?? '' }}</span></a></li>
                                    </ul>
            ...
            <div class="col-lg-9 col-md-12">
                <div class="dashboard-box margin-top-0">
                    <!-- Headline -->
                    <div class="headline">
                        <h3><i class="icon-feather-rotate-cw"></i> {{ __('quickad.resubmited_ads') }}</h3>
                    </div>
                        ...
                        <div class="table-responsive">
                            <table id="js-table-list" class="basic-table dashboard-box-list">
                                ...
                                <tr class="ajax-item-listing" data-item-id="{{ data_get($item ?? [], 'id', '') }}">
                                    ...
                                    <td>
                                       <span class="badge blue">{{ __('quickad.resubmited') }}</span>
                                    </td>
                                    <td>
                                        <a href="#" data-ajax-action="deleteResumitAd" class="button gray ripple-effect ico item-js-delete" data-tippy-placement="top" title="{{ __('quickad.delete') }}"><i class="icon-feather-trash-2"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                                {{ $else ?? '' }}
