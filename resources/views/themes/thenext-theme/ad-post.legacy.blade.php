        ...
        <div class="mfp-content">
            <div class="zoom-anim-dialog dialog-with-tabs popup-dialog">
                <ul class="popup-tabs-nav" style="pointer-events: none;">
                    <li class="active"><a href="#exist_acc">{{ __('quickad.link_exist_account') }}</a></li>
                </ul>
                    ...
                    <div class="popup-tab-content" id="exist_acc" style="">
                        <form accept-charset="utf-8" id="email_exists_login">
                            <p id="email_exists_success" style="display: none;">
                                <span class="status-available">{{ __('quickad.link_account_success') }}</span>
                            </p>
                            <p><span id="quickad_email_already_linked"></span>
                                <br>{{ __('quickad.enter_pass_link_ac') }}</p>
                            <p id="email_exists_error" style="display: none;"></p>
                            <div class="form-group">
                                <span>{{ __('quickad.username') }}:</span>
                                <strong id="quickad_username_display"></strong>
                            </div>
                            <div class="form-group">
                                <span>{{ __('quickad.email') }}:</span>
                                <strong id="quickad_email_display"></strong>
                            </div>
                            <div>
                                <span>{{ __('quickad.password') }}:</span>
...
<div id="titlebar" class="margin-bottom-0">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h2>{{ __('quickad.post_advertise') }}</h2>
                <!-- Breadcrumbs -->
                <nav id="breadcrumbs">
                    <ul>
                        <li><a href="{{ $link['INDEX'] ?? '#' }}">{{ __('quickad.home') }}</a></li>
                        <li>{{ __('quickad.post_advertise') }}</li>
                    </ul>
                </nav>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-8 col-md-12">
                ...
                <form class="form-validate" id="post-advertise-form" action="{{ $link['POST-AD'] ?? '#' }}?action=post_ad" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
                            ...
                            <div class="row">
                                <div class="col-xl-12">
                                    ...
                                    <div class="submit-field">
                                        ...
                                        <input type="text" class="with-border" name="title" placeholder="{{ __('quickad.ad_title') }}" required>
                                    </div>
                                    <div class="submit-field">
                                        <h5>{{ __('quickad.description') }} *</h5>
                                        <textarea cols="30" rows="5" class="with-border text-editor" name="content" placeholder="{{ __('quickad.ad_description') }}"></textarea>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-xl-6 col-md-12">
                                                <div class="input-with-icon">
                                                    <input class="with-border" type="text" placeholder="{{ __('quickad.price') }}" name="price">
