        ...
        <div class="forny-form">
            ...
            <div class="forny-content show-it" id="login-form">
                ...
                <div class="text-center">
                    ...
                    <p class="mb-10" id="login-status">{{ __('quickad.enter_details') }}</p>
                </div>
                ...
                <form action="ajaxlogin" id="lg-form">
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input required  class="form-control" type="text" id="username" placeholder="{{ __('quickad.username') }} / {{ __('quickad.email') }}">
                        </div>
                    </div>
                    <div class="form-group password-field">
                        ...
                        <div class="input-group">
                            ...
                            <input required  class="form-control" id="password" type="password" placeholder="{{ __('quickad.password') }}">
                    ...
                    <div class="row mt-6 mb-6">
                        <div class="col-6 align-items-center d-flex" >
                            <div class="custom-control custom-checkbox">
                                ...
                                <label class="custom-control-label" for="remember">{{ __('quickad.remember_me') }}</label>
                            </div>
                        </div>
                        <div class="col-6 text-right"><a href="#" class="forgot-page">{{ __('quickad.forgotpass') }}</a></div>
                    </div>

                    <div><button class="btn btn-primary btn-block" id="login">{{ __('quickad.login') }}</button></div>

                </form>
                <div class="mt-5 mb-5 text-center"><span>{{ __('quickad.or_log_with') }}</span></div>

                <div class="text-center">
                    @if(($facebook_app_id ?? "")!="")
                    <div class="d-inline-block mr-1">
                        <button class="btn btn-icon btn-flat text-facebook facebook-login" title="{{ __('quickad.login_facebook') }}">
                    ...
                    @if(($google_app_id ?? "")!="")
                    <div class="d-inline-block mr-1">
                        <button class="btn btn-icon btn-flat text-google gmail-login" title="{{ __('quickad.login_google') }}">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                 xmlns:xlink="http://www.w3.org/1999/xlink" width="32" height="32" viewBox="0 0 32 32">
                                <defs>
                    ...
                    <div class="d-inline-block">
                        <button class="btn btn-icon btn-flat text-twitter mobile-page" title="{{ __('quickad.login_with_phone') }}">
                ...
                <div class="text-center mt-6">
                    {{ __('quickad.dont_have_account') }} <a href="#" class="signup-page">{{ __('quickad.register') }}</a>
                </div>
            </div>
            ...
            <div class="forny-content hide-it" id="signup-form">
                ...
                <div class="text-center">
                    <h4>{{ __('quickad.create_an_account') }}</h4>
                    <p class="mb-10" id="signup-status">{{ __('quickad.setup_ac_txt') }}</p>
                </div>
                <form action="ajaxsignup" name="signup-form" id="reg-form" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input required  class="form-control" name="username" type="username" placeholder="{{ __('quickad.username') }}">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input required  class="form-control" name="email" type="email" placeholder="{{ __('quickad.emailad') }}">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input required class="form-control" name="phone" type="phone" placeholder="{{ __('quickad.phone_no') }}">
                        </div>
                    </div>
                    <div class="form-group password-field">
                        <div class="input-group">
                            ...
                            <input required  class="form-control" name="password" type="password" placeholder="{{ __('quickad.password') }}">
                            <div class="input-group-append cursor-pointer">
                                <span class="input-group-text">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="16" viewBox="0 0 24 16">
                                        <g transform="translate(0 0)">
                    ...
                    <div><button class="btn btn-primary btn-block" id="signup" type="submit">{{ __('quickad.register') }}</button></div>
                    <div class="line mt-10 mb-6"><span>{{ __('quickad.or') }} </span></div>
                    <div class="text-center">
                        @if(($facebook_app_id ?? "")!="")
                        <div class="d-inline-block mr-1">
                            <button class="btn btn-icon btn-flat text-facebook facebook-login" title="{{ __('quickad.login_facebook') }}">
                    ...
                    <div class="text-center mt-6">
                        {{ __('quickad.already_have_acc') }} <a href="#" class="login-page">{{ __('quickad.login_here') }}</a>
                    </div>
                </form>
            </div>
            ...
            <div class="forny-content hide-it text-center" id="forgot-form">
                ...
                <div class="reset-form d-block">
                    <div class="text-center">
                        <h4 class="mb-5">{{ __('quickad.forgotpass') }}</h4>
                        <p class="mb-10" id="forgot-status">{{ __('quickad.forgot_pass_notify') }}</p>
                    </div>
                    <form class="reset-password-form" action="forgot_pass" name="reset_pass_form" id="reset_pass_form" method="post">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <button class="btn btn-primary btn-block" id="forgot">{{ __('quickad.req_pass') }}</button>
                            </div>
                        </div>
                        <div class="text-center mt-6"><a href="#" class="login-page">{{ __('quickad.go_back') }}</a></div>
                    </form>
                </div>
                <div class="reset-confirmation d-none">
                    <h4 class="mb-5">{{ __('quickad.confirmation_mail_sent') }}</h4>
                    <div class="text-success">{{ __('quickad.checkemailforgot') }}</div>
                    <div class="text-center mt-6"><a href="#" class="login-page">{{ __('quickad.go_back') }}</a></div>
                </div>
            </div>
            ...
            <div class="forny-content hide-it text-center" id="mobile-form">
                ...
                <div class="reset-form d-block">
                    <form action="mobile_verify" name="pv-form" id="pv-form" method="post">
                        <h4 class="mb-5">{{ __('quickad.login_with_phone') }}</h4>
                        ...
                        <div class="text-center mt-10"><a href="#" class="login-page">{{ __('quickad.go_back') }}</a></div>
                    </form>
                </div>
                <div class="reset-confirmation d-none">
...
<script>
    ...
    var LANG_PHONE_VERIFIED_MSG = "{{ __('quickad.phone_verified_msg') }}";
    var LANG_AUTHENTICATING = "{{ __('quickad.authenticating') }}";
    var LANG_CHECKEMAILFORGOT = "{{ __('quickad.checkemailforgot') }}";
</script>
