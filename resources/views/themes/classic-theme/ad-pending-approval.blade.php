    ...
    <div class="container">
        <div class="breadcrumb-section">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">{{ __('quickad.pending_ads') }}</li>
                            ...
                            <div class="collapse-box">
                                ...
                                <div id="MyAds" class="panel-collapse collapse in">
                                    <ul class="acc-list">
                                        ...
                                        <li class="active"><a href="{{ $link['PENDINGADS'] ?? '#' }}" class="waves-effect"><i class="fa fa-info-circle"></i> {{ __('quickad.pending_ads') }}<span class="badge">{{ $pendingads ?? '' }}</span></a></li>
                    ...
                    <div class="my-quickad section">
                        ...
                        <table id="js-table-list" class="manage-table responsive-table">
                            ...
                            <tr class="ajax-item-listing" data-item-id="{{ data_get($item ?? [], 'id', '') }}">
                                <td class="title-container"><img src="{{ $site_url ?? '' }}storage/products/thumb/{{ data_get($item ?? [], 'picture', '') }}" alt="" style="max-height: 200px">
                                    <div class="item-title">
                                        ...
                                        <ul class="item-details">
                                            <li><i class="fa fa-map-marker"></i><a href="#">{{ data_get($item ?? [], 'location', '') }}</a></li>
                                ...
                                <td class="action" width="12%"><a href="{{ $link['EDIT-AD'] ?? '#' }}/{{ data_get($item ?? [], 'id', '') }}"><i class="fa fa-pencil"></i> {{ __('quickad.edit') }}</a><a class="delete item-js-delete" href="#" data-ajax-action="deleteMyAd"><i class="fa fa-remove"></i> {{ __('quickad.delete') }}</a></td>
                            </tr>
                            @endforeach
                            </tbody>
                        </table>
