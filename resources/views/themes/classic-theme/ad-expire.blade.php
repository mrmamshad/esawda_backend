    ...
    <div class="container">
        <div class="breadcrumb-section">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">{{ __('quickad.expire_ads') }}</li>
                    ...
                    <div class="section">
                        <div class="user-panel-sidebar">
                            <div class="collapse-box">
                                <h5 class="collapse-title no-border"> {{ __('quickad.my_classified') }}
                    ...
                    <div class="my-quickad section">
                        ...
                        <table id="js-table-list" class="manage-table responsive-table">
                            ...
                            <tr class="ajax-item-listing" data-item-id="{{ data_get($item ?? [], 'id', '') }}">
                                ...
                                <td class="action" width="12%"><a href="{{ $link['EDIT-AD'] ?? '#' }}/{{ data_get($item ?? [], 'id', '') }}"><i class="fa fa-pencil"></i> {{ __('quickad.renew') }}</a><a class="delete item-js-delete" href="#" data-ajax-action="deleteMyAd"><i class="fa fa-remove"></i> {{ __('quickad.delete') }}</a></td>
                            </tr>
                            @endforeach
                            </tbody>
                        </table>
