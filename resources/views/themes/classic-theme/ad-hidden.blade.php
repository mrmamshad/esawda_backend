    ...
    <div class="container">
        <div class="breadcrumb-section">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">{{ __('quickad.hidden_ads') }}</li>
                            ...
                            <div class="collapse-box">
                                ...
                                <div id="MyAds" class="panel-collapse collapse in">
                                    <ul class="acc-list">
                                        ...
                                        <li class="active"><a href="{{ $link['HIDDENADS'] ?? '#' }}" class="waves-effect"><i class="fa fa-eye-slash"></i> {{ __('quickad.hidden_ads') }} <span class="badge">{{ $hiddenads ?? '' }}</span></a></li>
                            ...
                            @foreach($item ?? [] as $item)
                                <tr class='ajax-item-listing @if((data_get($item ?? [], 'status', ''))=="hide") opapcityLight @endif' data-item-id="{{ data_get($item ?? [], 'id', '') }}">
                                    <td class="title-container"><img
                                            src="{{ $site_url ?? '' }}storage/products/thumb/{{ data_get($item ?? [], 'picture', '') }}" alt=""
